INSERT INTO UNITS (ID, LONG_NAME, SHORT_NAME, VERSION, CREATED_ON, MODIFIED_ON) VALUES
    ...
    (1005, 'Etwas', 'etwas', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
Does your lorem ipsum text long for something a little meatier? Give our generator a try… it’s tasty!', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	...
	(3010, 'Fix ohne Fix: Italienische Salatkrönung nach Feinkostpunks Art', 'Alle Zutaten miteinander gut vermischen.
...
INSERT INTO INGREDIENTS (ID, QUANTITY, UNIT_ID, FOOD_ID, RECIPE_ID, VERSION, CREATED_ON, MODIFIED_ON) VALUES
	...
	(4007, 3, 1002, 2006, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	(4008, 2, 1002, 2007, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	(4009, 1, 1002, 2008, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	(4010, 0.5, 1002, 2009, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	(4011, 0.5, 1002, 2010, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	(4012, 0.5, 1002, 2011, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	(4013, 2, 1002, 2012, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	(4014, 1, 1002, 2013, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	(4015, 2, 1002, 2014, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	(4016, 2, 1002, 2015, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
	(4017, 0.5, 1002, 2016, 3010, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
